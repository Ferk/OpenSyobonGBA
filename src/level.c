...
static const SourceEntry level_1_1_entries[] = {
    { 64, 1, 82 }, { 22, 2, 82 }, { 112, 2, 98 }, { 123, 2, 99 },
    { 6, 3, 82 }, { 52, 3, 50 }, { 14, 5, 98 }, { 49, 5, 98 },
    { 50, 5, 98 }, { 51, 5, 98 }, { 52, 5, 1 }, { 53, 5, 1 },
    { 57, 5, 1 }, { 58, 5, 1 }, { 59, 5, 1 }, { 74, 5, 2 },
    { 103, 5, 98 }, { 115, 5, 4 }, { 116, 5, 4 }, { 89, 6, 7 },
    { 114, 6, 4 }, { 115, 6, 4 }, { 116, 6, 4 }, { 48, 7, 50 },
    { 66, 7, 30 }, { 113, 7, 4 }, { 114, 7, 4 }, { 115, 7, 4 },
    { 116, 7, 4 }, { 35, 8, 98 }, { 112, 8, 4 }, { 113, 8, 4 },
    { 114, 8, 4 }, { 115, 8, 4 }, { 116, 8, 4 }, { 8, 9, 98 },
    { 12, 9, 1 }, { 13, 9, 98 }, { 14, 9, 1 }, { 15, 9, 2 },
    { 16, 9, 1 }, { 40, 9, 7 }, { 46, 9, 1 }, { 47, 9, 98 },
    { 48, 9, 1 }, { 59, 9, 98 }, { 66, 9, 1 }, { 67, 9, 98 },
    { 71, 9, 2 }, { 74, 9, 2 }, { 77, 9, 2 }, { 99, 9, 1 },
    { 100, 9, 1 }, { 101, 9, 2 }, { 102, 9, 1 }, { 111, 9, 4 },
    { 112, 9, 4 }, { 113, 9, 4 }, { 114, 9, 4 }, { 115, 9, 4 },
    { 116, 9, 4 }, { 1, 10, 80 }, { 13, 10, 7 }, { 20, 10, 40 },
    { 33, 10, 80 }, { 84, 10, 4 }, { 88, 10, 4 }, { 90, 10, 7 },
    { 91, 10, 7 }, { 92, 10, 7 }, { 93, 10, 7 }, { 94, 10, 7 },
    { 95, 10, 40 }, { 110, 10, 4 }, { 111, 10, 4 }, { 112, 10, 4 },
    { 113, 10, 4 }, { 114, 10, 4 }, { 115, 10, 4 }, { 116, 10, 4 },
    { 128, 10, 83 }, { 20, 11, 41 }, { 83, 11, 4 }, { 84, 11, 4 },
    { 88, 11, 4 }, { 89, 11, 4 }, { 95, 11, 41 }, { 106, 11, 40 },
    { 109, 11, 4 }, { 110, 11, 4 }, { 111, 11, 4 }, { 112, 11, 4 },
    { 113, 11, 4 }, { 114, 11, 4 }, { 115, 11, 4 }, { 116, 11, 4 },
    { 10, 12, 50 }, { 16, 12, 50 }, { 19, 12, 81 }, { 20, 12, 41 },
    { 26, 12, 81 }, { 27, 12, 98 }, { 46, 12, 81 }, { 61, 12, 50 },
    { 63, 12, 50 }, { 66, 12, 51 }, { 78, 12, 81 }, { 82, 12, 4 },
    { 83, 12, 4 }, { 84, 12, 4 }, { 88, 12, 4 }, { 89, 12, 4 },
    { 95, 12, 41 }, { 101, 12, 50 }, { 103, 12, 50 },
    { 106, 12, 41 }, { 108, 12, 4 }, { 109, 12, 4 }, { 110, 12, 4 },
    { 111, 12, 4 }, { 112, 12, 4 }, { 113, 12, 4 }, { 114, 12, 4 },
    { 115, 12, 4 }, { 116, 12, 4 }, { 123, 12, 4 }, { 124, 12, 81 },
};

static const SourceRun level_1_1_runs[] = {
...
void level_load_1_1(Level *level)
{
    ...
    for (uint16_t i = 0; i < sizeof(level_1_1_entries) / sizeof(level_1_1_entries[0]); ++i) {
        const SourceEntry *entry = &level_1_1_entries[i];
